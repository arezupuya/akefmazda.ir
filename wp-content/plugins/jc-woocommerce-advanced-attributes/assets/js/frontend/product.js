					...
					if( $.inArray("", check_attr) > -1 || $.inArray($(this).val(), check_attr) > -1 ){
						...
						if(_option !== false){
							...
							if(_attr.type === 'image'){
								...
								htmlOutput += '<li><div style="background: '+_option.color+';" data-target="#'+_select.attr('id')+'" title="'+_option.name+'" data-value="'+_option.value+'" class="jcaa_attr_option jcaa_obj_color"></div><span>'+_option.name+'</span></li>';	
